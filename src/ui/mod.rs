...
pub fn StatusBar(
    ...
    view! {
        <div class="fixed top-0 inset-x-0 flex justify-center pointer-events-none z-50 p-2">
            <div class="flex gap-6 rounded-lg bg-surface/80 px-4 py-1.5 text-xs font-mono text-subtle backdrop-blur-sm border border-border pointer-events-auto select-none">
                <span>
                    "screen: "
